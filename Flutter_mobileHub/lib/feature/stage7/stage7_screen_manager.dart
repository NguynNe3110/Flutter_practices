...
final List<Lesson> listLessonInStage7 = [
  // Lesson(
...
class Stage7Screen extends StatelessWidget {
  Stage7Screen({super.key});

  // Lấy danh sách từ AppData
  final List<Lesson> lessons = listLessonInStage7;
  ...
  Widget _buildLessonCard(BuildContext context, Lesson lesson) {
    return Card(
      ...
      child: InkWell(
        onTap: () {
          context.push('/stage7/${lesson.routePath}');
        },
        child: Padding(
