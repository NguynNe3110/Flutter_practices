...
final List<Lesson> listLessonInStage8 = [
  // Lesson(
...
class Stage8Screen extends StatelessWidget {
  Stage8Screen({super.key});

  // Lấy danh sách từ AppData
  final List<Lesson> lessons = listLessonInStage8;
  ...
  Widget _buildLessonCard(BuildContext context, Lesson lesson) {
    return Card(
      ...
      child: InkWell(
        onTap: () {
          context.push('/stage8/${lesson.routePath}');
        },
        child: Padding(
